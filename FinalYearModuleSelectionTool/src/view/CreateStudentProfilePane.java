...
public class CreateStudentProfilePane extends GridPane {
	...
	public void createButtonDisableBind(){
		btnCreateProfile.disableProperty().bind(txtFirstName.textProperty().isEmpty().or(txtSurname.textProperty().isEmpty().or(txtPnumber.textProperty().isEmpty().or(txtEmail.textProperty().isEmpty()))));
	...
	public Button getbtnCreateProfile() {
	  ...
	  public boolean checkPNumberValid() {
	        if(txtPnumber.getText().matches("[P-p].*")) {
	            return false;
	        } else {
	            return true;
	        }
	  ...
	  public int getcboValue() {
	         int index = cboCourses.getSelectionModel().getSelectedIndex();
	         return index;
	        }
	  ...
	  public Name getTxtNames() {
	      Name name = new Name(txtFirstName.getText(), txtSurname.getText());
	      return name;
	  }
